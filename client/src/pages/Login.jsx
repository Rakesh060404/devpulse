                ...
                <div className="bg-gray-800 rounded-xl shadow-2xl p-8">
                    <div className="text-center">
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="w-full bg-gray-700 hover:bg-gray-600 text-white font-medium py-3 px-6 rounded-lg transition-colors duration-200 flex items-center justify-center space-x-3 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
